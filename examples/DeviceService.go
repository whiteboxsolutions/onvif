...
import (
	...
	goonvif "github.com/whiteboxsolutions/onvif"
	"github.com/whiteboxsolutions/onvif/device"
	sdk "github.com/whiteboxsolutions/onvif/sdk/device"
	"github.com/whiteboxsolutions/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/whiteboxsolutions/onvif/gosoap for pretty printing response
